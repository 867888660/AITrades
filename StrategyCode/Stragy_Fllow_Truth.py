...
def _run_strategy(usedata, node_params):
    ...
    metrics_meta = {
        ...
        "fact_side": {"kind": "state", "label": "Fact Side"},
        "opp_side": {"kind": "state", "label": "Opposite Side"},
        "current_pos_source": {"kind": "state", "label": "Position Source"},
        "opposite_pos_source": {"kind": "state", "label": "Opposite Position Source"},
        "momentum_state": {"kind": "state", "label": "Momentum State"},
        "machine_state": {"kind": "state", "label": "Machine State"},
        "market_status": {"kind": "state", "label": "Market Status"},
        "cooldown_active": {"kind": "state", "label": "Cooldown Active"},
        "shock_cooldown_active": {"kind": "state", "label": "Shock Cooldown Active"},
        "shock_block_active": {"kind": "state", "label": "Shock Block Active"},
        "stop_loss_locked": {"kind": "state", "label": "Stop Loss Locked"},
        "quote_ok": {"kind": "state", "label": "Quote OK"},
        "fair_price": {"kind": "continuous", "label": "Fair Price", "unit": "price"},
        "entry_edge": {"kind": "continuous", "label": "Entry Edge", "unit": "price"},
        "full_entry_edge": {"kind": "continuous", "label": "Full Entry Edge", "unit": "price"},
        "exit_edge": {"kind": "continuous", "label": "Exit Edge", "unit": "price"},
        "target": {"kind": "continuous", "label": "Target Position", "unit": "ratio"},
        "target_delta": {"kind": "continuous", "label": "Target Delta", "unit": "ratio"},
        "position_cap_pct": {"kind": "continuous", "label": "Position Cap", "unit": "ratio"},
        "risk_scale": {"kind": "continuous", "label": "Risk Scale", "unit": "ratio"},
        "pnl_pct": {"kind": "continuous", "label": "PnL %", "unit": "ratio"},
        "macd_hist": {"kind": "continuous", "label": "MACD Hist"},
        "macd_hist_slope": {"kind": "continuous", "label": "MACD Hist Slope"},
        "drawdown_from_peak": {"kind": "continuous", "label": "Drawdown From Peak", "unit": "ratio"},
        "day_to_end": {"kind": "continuous", "label": "Days To End", "unit": "days"},
        "de_risk_multiplier": {"kind": "continuous", "label": "De-risk Multiplier", "unit": "ratio"},
    }
